...
import com.hunter.plugins.HunterUtils.utils.CombatUtils;
import com.hunter.plugins.HunterUtils.utils.InteractionUtils;
import com.hunter.plugins.HunterUtils.utils.NpcUtils;
...
@PluginDescriptor(name = "<html><font color=\"#ff2c2c\">Hunter </font>Auto Scurrius</html>", description = "Dodges Scurrius' falling ceiling attack and re-attacks", tags = {"hunter"})
public class LucidScurriusHelperPlugin extends Plugin
{
    ...
    @Inject
    private LucidScurriusHelperOverlay overlay;
