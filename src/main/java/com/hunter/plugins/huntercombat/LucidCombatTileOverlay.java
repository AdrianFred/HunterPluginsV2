package com.hunter.plugins.huntercombat;

import com.hunter.plugins.HunterUtils.utils.InteractionUtils;
...
public class LucidCombatTileOverlay extends OverlayPanel
{
    ...
    private final com.hunter.plugins.huntercombat.LucidCombatPlugin plugin;
    private final com.hunter.plugins.huntercombat.LucidCombatConfig config;

    @Inject
    private LucidCombatTileOverlay(Client client, com.hunter.plugins.huntercombat.LucidCombatPlugin plugin, com.hunter.plugins.huntercombat.LucidCombatConfig config)
    {
        this.client = client;
        this.plugin = plugin;
        this.config = config;
