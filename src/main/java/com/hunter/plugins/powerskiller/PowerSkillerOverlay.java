...
public class PowerSkillerOverlay extends OverlayPanel {
    ...
    private final com.hunter.plugins.powerskiller.PowerSkillerPlugin plugin;

    @Inject
    private PowerSkillerOverlay(com.hunter.plugins.powerskiller.PowerSkillerPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
