...
package com.hunter.plugins.HunterUtils.BreakHandler;
...
public class ReflectBreakHandler {
    ...
    public boolean needsBankPin(Client c) {
        Object o = this.performReflection("needsBankPin1", c);
        return o != null ? (Boolean)o : false;
    }

    public String getBankPin(ConfigManager configManager) {
        Object o = this.performReflection("getBankPin1", configManager);
